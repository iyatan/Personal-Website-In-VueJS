...
<div >
  ...
  <section id="projects">
    ...
    <div class="all-projects-wrapper">
      <Project git_link="https://github.com/iyatan/Messenger-Web-App" live_link="https://messenger-app-2ff31.web.app/" img_link="messager.gif" title="Messenger web app" description="Web App for messaging anyone on the platform"/>
  ...
  <section id="blog" style="min-height: 100vh">
    <div style="text-align: center; margin-top: 20%; font-size: 2em">
      No blog published yet! Check back in a few days
    </div>
